              ...
              <div className="flex items-start justify-between gap-3 mb-3">
                ...
                <div className="hidden sm:flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 text-sm font-medium underline hover:text-primary transition-colors"
                  >
              ...
              <div className="relative w-full max-w-5xl mt-4 md:mt-8">
                ...
                {imageUrls && imageUrls.length > 1 && (
                  <button
                    ...
                    className={`absolute left-3 top-1/2 -translate-y-1/2 text-white bg-black/60 rounded-full w-9 h-9 flex items-center justify-center hover:bg-black/80 transition-colors z-10 ${activeIndex === 0 ? "opacity-50 cursor-not-allowed" : "cursor-pointer"
                      }`}
                ...
                {imageUrls && imageUrls.length > 1 && (
                  <button
                    ...
                    className={`absolute right-3 top-1/2 -translate-y-1/2 text-white bg-black/60 rounded-full w-9 h-9 flex items-center justify-center hover:bg-black/80 transition-colors z-10 ${activeIndex === imageUrls.length - 1 ? "opacity-50 cursor-not-allowed" : "cursor-pointer"
                      }`}
          ...
          <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-5">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <Card className="rounded-xl">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="mt-3 rounded-lg h-8 text-xs"
                    onClick={() =>
              ...
              <div className="space-y-3">
                    ...
                    <div className="rounded-lg border overflow-hidden mb-3">
                      ...
                      <div className="grid grid-cols-2 border-b">
                        <div className="p-2.5 border-r">
                          ...
                          <input
                            ...
                            className="mt-0.5 w-full text-xs outline-none bg-transparent"
                          />
                      ...
                      <div className="p-2.5 flex items-center justify-between">
                        ...
                        <select
                          ...
                          className="text-xs border rounded-md px-1.5 py-0.5 bg-background"
                        >
                          {[1, 2, 3, 4, 5, 6].map((g) => (
                ...
                <button
                  type="button"
                  className="mx-auto flex items-center gap-1.5 text-xs text-muted-foreground underline hover:text-foreground"
